...
abstract class $MoneyCopyWith<$Res> {
  ...
  @useResult
  $Res call({int amountCents, String currency});
}
...
class _$MoneyCopyWithImpl<$Res, $Val extends Money>
  ...
  @override
  $Res call({Object? amountCents = null, Object? currency = null}) {
    return _then(
      _value.copyWith(
            amountCents:
                null == amountCents
...
class _$MoneyImpl implements _Money {
  const _$MoneyImpl({required this.amountCents, required this.currency});
